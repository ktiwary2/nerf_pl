...
python train_efficient_sm.py --dataset_name efficient_sm\
 --root_dir /home/gridsan/ktiwary/datasets/variable_cam/chair_res800_var_cam_v1_sigma150/ --N_importance 64\
 --N_samples 64 --num_gpus 0 1 --img_wh 128 128 --noise_std 0 --num_epochs 300 --optimizer adam --lr 0.00001\
 --exp_name CHAIRS_sigma150_128x128_single_image_grad_on_sm2_sigma_run1_2gpu --num_sanity_val_steps 1\
