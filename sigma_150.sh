...
python train_efficient_sm.py --dataset_name efficient_sm --root_dir ../../datasets/volumetric/results_500_v2_distance_transform_150/\
 ...
 --exp_name sigma/128x128_Nimp64_LN32_sm1_white_only --Light_N_importance 32 --shadow_method shadow_method_1 --grad_on_light\
 --batch_size 1024 > ./sigma_out/128x128_Nimp64_LN32_sm2_white_only.out