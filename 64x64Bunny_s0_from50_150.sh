...
python train_efficient_sm.py --dataset_name efficient_sm\
 --root_dir ../../datasets/variable_cam/results_500_v2_bunny_var_cam/\
 --N_importance 128 --N_samples 128\
 --num_gpus 0 --img_wh 64 64 --noise_std 0\
 --num_epochs 550 --optimizer adam --lr 0.00001\
 --exp_name BUNNY_SIGMA_0_from50_150_scratch_64x64_sm2_nimp128_nsamp64_run1\
