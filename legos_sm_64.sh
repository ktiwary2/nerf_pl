...
# Run the script
python train_efficient_sm.py --dataset_name efficient_sm --root_dir ../../datasets/volumetric/results_500_lego_shadows/\
 --N_importance 128 --N_samples 64 --num_gpus 0 --img_wh 64 64 --noise_std 0 --num_epochs 200 --batch_size 4096\
 --optimizer adam --lr 0.00001 --exp_name legos/sm_only_Nimp128_64x64_LN64_sm2_blur0 --num_sanity_val_steps 1\
 --Light_N_importance 64 --shadow_method shadow_method_2 --grad_on_light > ./legos/sm_only_Nimp128_64x64_LN64_sm2_blur0
