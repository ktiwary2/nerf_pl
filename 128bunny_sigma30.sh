...
# Run the script
python3 train_variable_light.py --img_wh 128 128 --exp_name BUNNY_SIGMA30_128x128_sm2_smapper2d --use_disp\
 --shadow_method shadow_method_2 --num_epochs 500\
 --root_dir ../../datasets/variable_light/results_200_bunny_var_light_fov50_sigma30/ --N_importance 32\
