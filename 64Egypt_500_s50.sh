...
python train_efficient_sm.py --dataset_name efficient_sm\
 --root_dir /home/gridsan/ktiwary/datasets/variable_cam/egypt_statue_res800_var_cam_v1_sigma50/\
 --N_importance 128 --N_samples 128 --num_gpus 0 --img_wh 64 64 --noise_std 0 --num_epochs 300\
 --optimizer adam --lr 0.00001 --exp_name EGPYT_SIGMA_50_64x64_run1 --num_sanity_val_steps 1\
