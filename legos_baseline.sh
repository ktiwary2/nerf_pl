...
python train_rgb_sm_juntos.py --dataset_name rgb_sm --root_dir ../../datasets/volumetric/results_500_lego_shadows/\
 ...
 --optimizer adam --lr 0.00001 --exp_name legos/baseline_128x128_Nimp64_LN0_grad_off_bluroff_smw0 --Light_N_importance 0 --shadow_method shadow_method_2\
 --sm_weight 0.0 > ./legos/baseline_128x128_Nimp64_LN0_grad_off_bluroff_smw0.out