...
# Run the script
python train_efficient_sm.py --dataset_name pyredner2 --root_dir ../../datasets/pyredner_volumetric/single_cuboid/ --N_importance 64 --N_samples 64 --num_gpus 0 --img_wh 64 64 --noise_std 0 --num_epochs 300 --batch_size 4096 --optimizer adam --lr 0.00001 --exp_name pyredner_Nimp64_64x64_LightNimp16_shadowmethod2_coordstrans_grad_on_light_blur --num_sanity_val_steps 1 --Light_N_importance 16 --shadow_method shadow_method_2 --blur --coords_trans --grad_on_light
