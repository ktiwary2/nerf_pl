...
python train_efficient_sm.py --dataset_name efficient_sm\
 ...
 --exp_name 64x64_results_500_v2_vase_sigma0_gradon_run3_2gpu --num_sanity_val_steps 1 --Light_N_importance 128\
 --grad_on_light --batch_size 4096\
 --ckpt_path ./eff_sm_updated_light_matrix_NEW/ckpts/64x64_resulst_500v2_vase_sigma150_on_sm2_2gpu/epoch=44.ckpt