...
python train_efficient_sm.py --dataset_name efficient_sm\
 ...
 --exp_name 64x64_results_500_v2_64Vase_sigma150to50_e55 --num_sanity_val_steps 1\
 --Light_N_importance 128 --grad_on_light --batch_size 4096\
 --ckpt_path ./eff_sm_updated_light_matrix_NEW_feb20/ckpts/VASE_SIGMA150_64x64_sm2_nimp128_nsamp64_run1/epoch=55.ckpt