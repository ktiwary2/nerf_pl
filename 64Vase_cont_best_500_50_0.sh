...
python train_efficient_sm.py --dataset_name efficient_sm\
 ...
 --N_importance 128 --N_samples 128 --num_gpus 0 --img_wh 64 64 --noise_std 0 --num_epochs 500\
 --optimizer adam --lr 0.00001\
 --exp_name 64x64_results_500_v2_64Vase_sigma150to50to0_e499 --num_sanity_val_steps 1\
