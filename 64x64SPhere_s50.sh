...
python train_efficient_sm.py --dataset_name efficient_sm\
 --root_dir /home/gridsan/ktiwary/datasets/variable_cam/results_500_v2_sphere/\
 --N_importance 128 --N_samples 64 --num_gpus 0 --img_wh 64 64 --noise_std 0 --num_epochs 600\
 --optimizer adam --lr 0.00001 --exp_name SPHERE_SIGMA_50_to_0_64x64_sm2_nimp128_nsamp64_run1 --num_sanity_val_steps 1\
